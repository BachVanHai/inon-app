...
import { KEY_ACTIVE_STEP, KEY_PAY_CONTRACT_STATUS, MAX_STEP } from '../../../../../../redux/reducers/insurance-app/buyInsurancesVta'
import FooterView from '../../views/FooterView'
import { backStep } from '../../../../../../redux/actions/insurance-app/buyInsurancesVta'
import StepBase from '../../../../../../components/insurance-app/buy-insurances-page/step/StepBase'

const Step = () => {
    const {
        [KEY_ACTIVE_STEP]: activeStep, [KEY_PAY_CONTRACT_STATUS]: payContractStatus,
