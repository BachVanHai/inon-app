...
export const validationSchema = Yup.object().shape({
    [KEY_NAME_BENEFICIARY]: Yup.string().required(config.ALERT_EMPTY),
    [KEY_IC_TYPE_BENEFICIARY]: Yup.string()
    .required(config.ALERT_EMPTY),
    ...config.getDefault_validateSchemaIcNo(KEY_IC_NO_BENEFICIARY, KEY_IC_TYPE_BENEFICIARY),
