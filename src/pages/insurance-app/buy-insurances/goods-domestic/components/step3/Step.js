...
import { backStep, updateProps } from '../../../../../../redux/actions/insurance-app/buyInsurancesGoods'
import { BASE, KEY_GOODS_SUGGESTION, KEY_INSURANCE_INFO, KEY_STEP_2, MAX_STEP } from '../../../../../../redux/reducers/insurance-app/buyInsurancesGoods'
...
import { getDefault_updatePaymentContractObj, payContract, updateContract } from './utility'
...
const Step = () => {
    ...
    const {
        ...
        [KEY_GOODS_SUGGESTION] : goodsSuggestion
    ...
    //         updateContract(
    //             contractId ,
    //             getDefault_updatePaymentContractObj(paymentType, contractInfo) , paymentType
    //         )
    //     )
    // }, [])
