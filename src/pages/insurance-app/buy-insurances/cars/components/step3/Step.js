...
import {
    initialValues, invoiceTypeCops, invoiceTypeInsurBuyer, invoiceTypePers, KEY_INVOICE_TYPE,
    KEY_IS_SAVE_TEMPLATE, KEY_TEMPLATE_NAME, validate, validationSchema
} from './formikConfig'
...
import { resetState } from '../../../../../../redux/actions/insurance-app/buyInsurancesCars'
...
import { MAX_STEP } from '../../../../../../redux/reducers/insurance-app/buyInsurancesCars'
