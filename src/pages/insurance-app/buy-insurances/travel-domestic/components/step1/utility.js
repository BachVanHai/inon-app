...
import { BASE } from '../../../../../../redux/reducers/insurance-app/buyInsurancesTravelDomestic'
import {
...
export const API_CONTRACTS_TRAVEL_INSURANCE =
  'nth/homeinsurance/api/contracts-travel'
export const API_CREATE_INSURANCES =
  'nth/homeinsurance/api/travel-insurances'
...
export const API_BENEFICIARIES = 'nth/homeinsurance/api/contracts-travel-info'
export const updateBeneficiaries = (contractId, data) => {
  return async (dispatch, getState) => {
    try {
      const res = await HttpClient.put(
        `${API_BENEFICIARIES}/${contractId}`,
        data
      )
      if (res.status === 200) {
        dispatch(
...
export const getObj_updateAddOns = () => {
  // return (dispatch) =>{
