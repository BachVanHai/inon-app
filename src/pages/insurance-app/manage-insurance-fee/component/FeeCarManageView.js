...
const FeeCarManageView = ({ location }) => {
    ...
    <Row>
      <Col sm="12">
        ...
        <TabContent className="py-50" activeTab={companySelected}>
          <FeeCarManageBSHView companyId={companySelected} role={role} editable={editable} data={role === 'VIEW' ? location.state.data : ''} userId={userId} />
        </TabContent>
      </Col>
    </Row>
  )
}
export default FeeCarManageView
