...
import FeeWordwideManageBSHView from './FeeWordwideManageBSHView';
    ...
    <Row>
      <Col sm="12">
        ...
        <TabContent className="py-50" activeTab={companySelected}>
          <FeeWordwideManageBSHView companyId={companySelected} role={role} editable={editable} data={role === 'VIEW' ? location.state.data : ''} userId={userId} childUserArr={childUserArr} />
        </TabContent>
      </Col>
    </Row>
  )
