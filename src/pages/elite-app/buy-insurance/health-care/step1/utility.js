...
import { KEY_ADDRESS, KEY_ADDTIONAL_PEOPLE, KEY_BANK, KEY_CITY, KEY_DATE_BIRTH, KEY_DISTRICT, KEY_EMAIL, KEY_FULLNAME, KEY_GENDER, KEY_IC_NO, KEY_IC_TYPE, KEY_PHONE_NUMBER, KEY_REF_ID, KEY_STK, KEY_WARD } from './formikConfig'
export const API_CONTRACTS_HCAC = "nth/personalinsurance/api/authenticate/contracts/hcac"
...
export const getDefault_createContractObj = (values , ref_id) => {
    const {
...
export const API_BENEFICIARIES = "/nth/personalinsurance/api/authenticate/beneficiaries-hcac"
...
export const getDefault_updateBeneficiariesObj = (values, contractInfo) => {
    ...
    const arr = getDefault_createContractObj(values)
