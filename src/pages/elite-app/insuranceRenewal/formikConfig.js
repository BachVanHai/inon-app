...
import { ALERT_EMPTY, ALERT_MIN_VND } from '../../../components/insurance-app/buy-insurances-page/formik-config'
...
export const initialValues = {
    ...
    [KEY_DATE_INSUR_FROM]: moment().format('YYYY-MM-DD'),
    [KEY_DATE_INSUR_TO]: moment().add(1, 'y').format('YYYY-MM-DD'),
    ...
    [KEY_GROSS_TON]: 1,
    [KEY_GT_XE_KHAIBAO]: _MIN_INITVALUE,
    [KEY_GTBH_YEUCAU]: _MIN_INITVALUE,
    [KEY_BH_INCREASE]: 0,
    [KEY_LOADS]: 0.1,
...
export const validateSchema = Yup.object().shape({
    ...
    [KEY_PHONE_NUMBER]: Yup.string().when(KEY_EMAIL, {
        is: undefined,
        then: Yup.string().required(ALERT_EMPTY)
    })
}, [KEY_EMAIL, KEY_PHONE_NUMBER])