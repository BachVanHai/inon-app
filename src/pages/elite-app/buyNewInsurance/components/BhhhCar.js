...
const BhhhCar = ({ errors, values, touched, setFieldValue, getFieldMeta, disableContinueBtn }) => {
  ...
  return (
    ...
    <div className="mb-3">
                <Row>
                    <Col sm="12">
                        <label className="font-small-2"> <em><FormattedMessage id={getKeyLang("ExtendInsBBHHCarTNDS")} /></em></label>
                        <br /><br />
                    </Col>
                    ...
                    <Col md="3" sm="12" className="margin-top-14 mt-4">
                        <label>
                    ...
                    <Col md="9" sm="12" className="margin-top-14 mt-4">
                        <Slider
                            min={10}
                            max={50}
                            step={10}
