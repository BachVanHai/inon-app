    ...
    <TableStyled responsive bordered>
      ...
      <tr>
        ...
        <tr>
          ...
          <td>
            <div className='d-flex justify-content-center'>
            <Checkbox icon={<Check className='vx-icon' size={16} />}  defaultChecked={true} checked={true}/>
            </div>
          </td>
          <td>
            <div className='d-flex justify-content-center'>
        ...
        <tr>
          ...
          <td>
            <div className='d-flex justify-content-center'>
              <Checkbox icon={<Check className='vx-icon' size={16} />}  defaultChecked={false} checked={false} />
            </div>
          </td>
        </tr>
        {/* ====row 3 ====   */}
