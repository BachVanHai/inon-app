import { ACTION_BUY_INSUR_TRAVEL_RESET_ALL, ACTION_BUY_INSUR_TRAVEL_UPDATE_PROPS } from "../../reducers/insurance-app/buyInsurancesTravel"
...
export const updateProps = (properties) => {
    return (dispatch) => {
        dispatch(
            {
                type: ACTION_BUY_INSUR_TRAVEL_UPDATE_PROPS,
                payload: properties
            }
        )
    }
...
export const resetState = () => {
    return (dispatch) => {
        dispatch({
            type: ACTION_BUY_INSUR_TRAVEL_RESET_ALL,
        })
    }
}
