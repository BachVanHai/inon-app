...
import { NAME_BUY_INSURANCES_PERSONAL_HOME, COMPANIES, PAID_WAITING } from "../../../configs/insurance-app"
import {
    KEY_ADDRESS, KEY_CITY, KEY_DISTRICT, KEY_WARD, initialValues as step1Default
} from "../../../pages/insurance-app/buy-insurances/personal-home/components/step1/formikConfig"
import { ACTION_MERGE_PROPS, ACTION_RESET_ALL, ACTION_UPDATE_PROPS } from "../../actions/insurance-app/buyInsurancesPersonalHome"

export const REDUX_STATE_NAME = NAME_BUY_INSURANCES_PERSONAL_HOME
